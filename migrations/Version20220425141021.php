 ...
 */
final class Version20220425141021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces ADD categories_id INT NOT NULL, ADD slug VARCHAR(255) NOT NULL, ADD active TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces DROP categories_id, DROP slug, DROP active');
    }
}
